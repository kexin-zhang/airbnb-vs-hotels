...
queue().defer(d3.csv, "static/js/location_cell_centers.csv")
       .defer(d3.csv, "static/js/prices_aggregated2.csv")
...
function showResults(data) {    
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i]._index == "airbnb") {
            ...
            img.src = "static/js/airbnb_logo.png";
...
function reviewBarChart(location_cell) {
    ...
    queue().defer(d3.csv, "static/js/hotel_sentiments.csv")
           .defer(d3.csv, "static/js/air_sentiments.csv")
